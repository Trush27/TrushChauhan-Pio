...
namespace Web.Controllers
{
    public class MenuController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetItemsByCategory(int categoryId, int page = 1, int pageSize = 5, string searchTerm = "")
        {
            var result = await _menuService.GetItemsByCategoryPaginatedAsync(categoryId, page, pageSize, searchTerm);
            return Json(new { 
                items = result.Items, 
        ...
        [HttpGet]
        public async Task<IActionResult> GetModifiersPaginated(int modifierGroupId, int page = 1, int pageSize = 5, string searchTerm = "")
        {
            var result = await _modifierService.GetModifiersByGroupPaginatedAsync(modifierGroupId, page, pageSize, searchTerm);
            return Json(new
            {
