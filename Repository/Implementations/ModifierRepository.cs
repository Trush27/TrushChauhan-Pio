...
namespace Repository.Implementations
{
    public class ModifierRepository : IModifierRepository
    {
        ...
        public async Task<(List<Modifier> Modifiers, int TotalItems)> GetModifiersByGroupPaginatedAsync(int modifierGroupId, int page, int pageSize, string searchTerm)
        {
